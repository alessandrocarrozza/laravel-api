...
<form action="{{route("admin.projects.update", ["project" => $project->slug])}}" method="POST">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control @error("content") is-invalid @enderror" placeholder="Inserisci contenuto" name="content" id="content" style="height: 100px">{{old("content", $project->content)}}</textarea>
